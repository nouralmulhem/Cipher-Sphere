...
index=0
channel=0
fake_string=generate_new_string(available_chars,5)
channel,total_budget = prepare_message([fake_string],[new_message[index]],total_budget,channel,team_id,carrier_image)
